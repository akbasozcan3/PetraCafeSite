...
export default async function SiteShell({
  ...
  return (
    <div className="site-home site-shop" style={themeToCssVars(content.theme)}>
      ...
      />
      <link rel="stylesheet" href="/assets/css/style.css?v=20260824v105" />
      <link rel="stylesheet" href="/assets/css/home-next.css?v=20260824v105" />
      <link rel="stylesheet" href="/assets/css/storefront.css?v=20260824v105" />
