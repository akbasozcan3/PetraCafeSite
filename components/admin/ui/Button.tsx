      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 rounded-2xl disabled:opacity-50 disabled:pointer-events-none",
          {
            ...
            "bg-[#1A1A1A] text-[#EEE9E0] border border-white/[0.06] hover:bg-[#222] hover:border-white/10":
              variant === "secondary",
            ...
            "border border-white/[0.06] text-[#EEE9E0] hover:bg-white/[0.04] hover:border-white/10":
              variant === "outline",
