...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  sayfalar: {
    urunler: {
      ...
      altNot: "Sunum menüsü — sepet yok; fırından gel-al veya iletişime geçin.",
    },
    urunKategori: {
      eyebrow: "Ürünler",
      ...
      detayNotlari:
        "Gel al veya telefon / WhatsApp siparişi\n7/24 WhatsApp ile hızlı yanıt",
      detayWaLabel: "WhatsApp ile Sipariş",
    ...
    blog: {
      ...
      lead: "Pasta siparişi, ekmek saklama, un çeşitleri ve mutfaktan pratik yazılar.",
