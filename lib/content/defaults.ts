...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  marquee: ["TAZE", "LEZZETLİ", "DOĞAL", "HER GÜN TAPTAZE", "ÖZEL TASARIM PASTA", "ÇEKMEKÖY TAŞDELEN"],
  ...
  hakkimizda: {
    ...
    answerBaslik: "Kısaca",
    answerMetin:
      "Taşdelen Fırıncı, Çekmeköy Taşdelen'de bulunan bir fırın ve pastanedir. Her gün taze üretilen ekmek, simit, poğaça, börek, kurabiye, baklava ve pasta çeşitleri sunar; şeker hamurlu özel tasarım pasta siparişi alır.",
    lead: "Çekmeköy Taşdelen'de yer alan fırınımızda, doğal ve taze ürünlerle müşterilerimize kaliteli hizmet sunmayı amaçlıyoruz.",
    body: [
      ...
      "Kahvaltı sofranız için: susamlı simit, tereyağlı simit, sade ve peynirli poğaça, kaşarlı açma, tereyağlı kol böreği ve günlük ekmek çeşitlerimiz sabahın erken saatlerinden itibaren tezgâhta bulunur.",
    ],
    ozet: [
      { b: "Her gün", span: "taze üretim" },
      { b: "14", span: "ürün kategorisi" },
      { b: "Özel tasarım", span: "pasta siparişi" },
      { b: "Taşdelen", span: "Çekmeköy / İstanbul" },
    ],
    badgeBaslik: "Taze",
