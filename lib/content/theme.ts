...
export function themeToCssVars(
  ...
  return {
    ...
    ["--line" as string]: isDark ? "rgba(217, 164, 65, 0.18)" : `rgba(${inkRgb}, 0.14)`,
    ["--line-d" as string]: isDark ? "rgba(217, 164, 65, 0.22)" : `rgba(${creamRgb}, 0.16)`,
    ...
    ["--card-border" as string]: isDark ? "rgba(217, 164, 65, 0.25)" : "rgba(13, 15, 10, 0.12)",
    ["--card-text" as string]: isDark ? "#F4EEE1" : "#0D0F0A",
    ["--card-muted" as string]: isDark ? "#A8A294" : "#6E6A5C",
    ...
    // Reviews tema değişkenleri
    ["--reviews-ink" as string]: isDark ? "#F4EEE1" : "#0D0F0A",
    ["--reviews-muted" as string]: isDark ? "#A8A294" : "#6E6A5C",
    ["--reviews-line" as string]: isDark ? "rgba(217, 164, 65, 0.2)" : "rgba(13, 15, 10, 0.12)",
    ["--reviews-brass" as string]: t.brass,
    ["--reviews-paper" as string]: isDark ? "#141810" : "#FFFFFF",
    background: t.paper,
    color: t.ink,
  } as CSSProperties;
}
